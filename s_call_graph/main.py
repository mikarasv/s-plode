...
from .custom_types import FuncName, NodeDict, NodeIndex, VarAndType
...
def build_s_graph(
    ...
    drawer1 = Drawer(
        file_path, cast(GraphRx, visitor.graph), "ast", ansatz, operations, draw
    )
    drawer1.draw_graph()
    ...
    return SGraphBuildRet(
        ast_graph=cast(GraphRx, visitor.graph),
